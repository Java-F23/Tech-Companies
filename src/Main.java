...
public class Main {
    ...
    private static void fillDb(){
        ...
        Project project1 = new Project(1, "Google Search Improvement", "Technology", new BigDecimal(10));
        ...
        Project project2 = new Project(2,"New MacBook Design", "Technology", new BigDecimal(20));
        ...
        Project project3 = new Project(3,"Customer Recommendation System", "Technology", new BigDecimal(30));
        ...
        Project project4 = new Project(4, "Autonomous Driving System", "Technology", new BigDecimal(40));
        ...
        Project project5 = new Project(5, "Cloud Computing Platform", "Technology", new BigDecimal(50));
        ...
        Project project6 = new Project(6,"Social Network Analysis", "Technology", new BigDecimal(60));
        ...
        Project project7 = new Project(7,"Recommendation Algorithm", "Technology",new BigDecimal(70));
        ...
        Project project8 = new Project(8,"Blockchain Technology", "Technology",new BigDecimal(80));
        ...
        Project project9 = new Project(9,"Brand Promotion Campaign", "Marketing",new BigDecimal(90));
